...
model_food.add(LSTM(128,return_sequences=True))
model_food.add(Dropout(0.2))
model_food.add(LSTM(100, return_sequences=False))
model_food.add(Dropout(0.2))
...
model_area.add(LSTM(128,return_sequences=True))
model_area.add(Dropout(0.2))
model_area.add(LSTM(100, return_sequences=False))
model_area.add(Dropout(0.2))
...
model_price.add(LSTM(128,return_sequences=True))
